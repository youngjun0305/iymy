...
public class alarm_add extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        medlist_addIcon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(alarm_add.this, add_alarm.class);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
                AlertDialog.Builder dlg = new AlertDialog.Builder(alarm_add.this);
                dlg.setTitle("삭제");
    ...
    public void setting_list(){
        ...
        modifyListAdapter = new modifyListAdapter(alarm_add.this, modify_list_itemArrayList);
